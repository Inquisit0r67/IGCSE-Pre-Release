using System; //This program is courtesy of S.Jani 11W [pls no steal :(]
            ...
            while (EOD == false){                
                ...
                while (check1 == true){
                    ...
                    if (input1 == "y" & In_Stock == true){ //If "y" is selected and items are in stock the order will be saved
                        ...
                        break;}
                    else if (input1 == "n" || In_Stock == false){ //If "n" is selcetd or the items are not in stock no order details will be saved
                ...
                while (Check == true){
                    ...
                    if (Input == "y") { //If its end of day the program prints out the number of orders made and all the unique order numbers
                        ...
                        WriteLine("\nAmount sold of each product:"); //Once again Linq saves the day with .Zip. (explained in README.md)
                        ...
                        for (int i = 0; i < Amount_sold.Length; i++){ //Iterrates through array Amount_sold            
                            WriteLine(Components[i] + ": " + Amount_sold[i]);} //Prints out the array amount with components in a nice table format
                        ReadKey();
                        EOD = true;
                        break;}
                ...
                Order_price.Clear();}}}} //Read my README.md for more info on my use of Linq
